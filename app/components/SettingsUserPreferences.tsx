...
interface SettingsUserPreferencesProps {
...
export default function SettingsUserPreferences({ onPreferencesChange }: SettingsUserPreferencesProps) {
      ...
      <div className="p-6 border-b border-gray-100">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 text-sm mt-1">Customize your sports viewing experience</p>
          </div>
          {saveStatus === 'saved' && (
      ...
      <div className="p-6">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center mt-6 pt-4 border-t border-gray-100 space-y-3 sm:space-y-0 sm:space-x-3">
          ...
          <button
            ...
            className="w-full sm:w-auto px-6 py-2 animated-purple-blue-bg text-white rounded-lg hover:opacity-90 transition-all font-medium shadow-md hover:shadow-lg transform hover:scale-105 flex items-center justify-center space-x-2"
          >
          ...
          <button
            onClick={() => {
              ...
              onPreferencesChangeRef.current?.(defaultPreferences)
